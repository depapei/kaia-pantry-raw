      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2 space-y-6">
            <h2 className="text-3xl font-serif text-white italic">Kaia</h2>
            <p className="max-w-sm text-stone-400 font-light leading-relaxed">
              Bringing the authentic taste of artisanal French baking to your
              neighborhood. Every loaf is a labor of love.
            </p>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-sm font-light">
              <li className="flex items-start gap-3">
                ...
                <span>
                  123 Boulangerie Way <br /> Paris, France 75004
                </span>
              </li>
        ...
        <div className="pt-8 border-t border-stone-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-stone-500 uppercase tracking-widest">
          <p>© {new Date().getFullYear()} Kaia Pantry. All rights reserved.</p>

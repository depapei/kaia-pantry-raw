      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <span className="text-bakery-crust uppercase tracking-widest text-xs font-bold">
              Our Story
            </span>
            <h2 className="text-4xl md:text-5xl font-serif leading-tight">
              The Secret is in <br />{" "}
              <span className="italic">the Patience.</span>
            </h2>
            <div className="space-y-6 text-stone-600 font-light leading-relaxed">
              <p>
                Founded on the belief that bread is more than just
                sustenance—it's a connection to the earth and our heritage. At
                Kaia, we honor the slow traditions of French baking.
              </p>
              <p>
                Every loaf begins with our 30-year-old starter, "Céleste," and
                undergoes a minimum 24-hour cold fermentation process. This
                patience yields a complex flavor profile and a texture that is
                as nourishing as it is delicious.
              </p>
              <p>
                We source our grains exclusively from organic, regenerative
                farms, ensuring that every bite supports both your health and
                the planet.
              </p>
            </div>
